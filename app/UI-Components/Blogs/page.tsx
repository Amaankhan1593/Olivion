  ...
  return (
    <>
       <div className="section-bg text-white flex flex-col">
        <h1 className="text-8xl GolosText mt-15 ">Our Blog</h1>
      ...
      <div className="px-[8%] lg:px-[12%] py-30">
         <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">                    
                        ...
                        <div key={index} className="group cursor-pointer">
                          <Link href={`/UI-Components/Blogs/${blog.id}`}>
                             ...
                             <div className="blog-info mt-3">
                               ...
                               <h2 className="text-4xl md:text-3xl CalSans my-5 hover:text-(--prim) transition-all duration-300">{blog.title}</h2>
                    ...
                    <div className="flex justify-center mt-10">
                        <button onClick={() => setShowAll(!showAll)} className="px-8 py-3 bg-(--prim)
                        cursor-pointer text-white rounded GolosText text-xl font-semibold hover:bg-black
