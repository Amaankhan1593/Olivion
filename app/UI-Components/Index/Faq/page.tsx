...
const faqData = [
    ...
    {
        id: "06",
        question: "How long does a typical prooject take?",
        answer: "Our interior design services cover everything you need to create a stunning and functional space. From initial concept development and space planning to selecting color schemes, furniture, and custom designs, we bring your vision to life."
    },
]
    ...
    <>
      <div className="px-[8%] lg:px-[12%] py-30">
        <div className="flex flex-col lg:flex-row gap-10">
            ...
            <span className="rounded-full title-span border border-gray-400 px-6 py-2 GolosText uppercase font-bold">Popular Queries</span>
            </div>
            <div className="w-full lg:h-2/3">
             <h1 className="CalSans text-4xl ml-10 md:text-7xl mb-5">Quick and clear <span className="text-(--prim)">Answers To Your Key</span> services</h1> 
            </div>
         </div>
         <div className="flex flex-col lg:flex-row gap-8 py-10">
            ...
            <div className="faq-card flex flex-col md:flex-row lg:flex-col md:items-center items-start gap-6">
                ...
                <div className="flex flex-col">
                    ...
                    <p className="text-gray-400 text-lg GolosText">Our team will guide you through our design process, project specifications and cost estimate.</p>
                </div>
            </div>
            </div>
         </div>
