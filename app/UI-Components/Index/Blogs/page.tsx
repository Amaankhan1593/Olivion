  ...
  return (
    ...
    <div className="px-[8%] lg:px-[12%] py-30 pb-20">
        <div className="flex flex-col lg:flex-row gap-10">
            ...
            <span className="rounded-full title-span border border-gray-400 px-7 py-2 GolosText uppercase font-bold">Our latest Blogs</span>
            </div>
            <div className="w-full lg:w-2/3">
             <h1 className="CalSans text-4xl ml-10 md:text-7xl mb-5 w-full lg:w-[80%] ">Take A look At <span className="text-(--prim)">Our Latest Blog <br /> </span>& Articles.</h1> 
            </div>
         </div>
                  ...
                  <div className="flex flex-col md:flex-row group cursor-pointer mb-5 gap-4">
                    <div className="w-full lg:w-1/2 blog-image relative rounded-2xl overflow-hidden">
                     ...
                     <div className="w-full lg:w-1/2 blog-info mt-3">
                       <p className="GolosText text-gray-400">by <span className="text-(--prim) font-semibold">{blog.postby}</span></p>
                       <h2 className="text-3xl md:text-2xl CalSans my-2 hover:text-(--prim) transition-all duration-300">{blog.title}</h2>
                       <p className="text-gray-500 GolosText">{blog.desc}</p>
                     </div>
                  </div>                     
                  </Link>
