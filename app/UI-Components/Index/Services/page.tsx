    ...
    <>
     <div className="px-[8%] lg:px-[12%] pt-20 pb-60 service relative">
       <div className="flex flex-col lg:flex-row gap-10">
         ...
         <div className="service-card border-b border-gray-400 cursor-pointer py-2 flex flex-col md:flex-row
         justify-between items-start md:items-center gap-5 mt-4">
            ...
            <i className="bi bi-arrow-up-right transition-all text-xl duration-300"></i>
         </div>
         {/*  */}
         <div className="service-card border-b border-gray-400 cursor-pointer py-2 flex flex-col md:flex-row
         ...
         justify-between items-start md:items-center gap-5 ">
            <div className="flex flex-col md:flex-row w-full md:w-[70%] gap-2 md:gap-8">
                ...
                <div className="service-content">
                    ...
                    <p className="GolosText text-gray-400">Providing professional advice on concepts, color schemes, and material selection — helping clients make informed design choices that balance aesthetics and functionality while ensuring each space reflects their personal vision, style, and desired atmosphere.</p>
                </div>
            </div>
            <div className="overflow-hidden h-full md:h-[210px] w-full md:w-[300px]">
         ...
         justify-between items-start md:items-center gap-5 ">
            <div className="flex flex-col md:flex-row w-full md:w-[70%] gap-2 md:gap-8">
                ...
                <div className="service-content">
                    ...
                    <p className="GolosText text-gray-400">Extending design services to outdoor spaces such as gardens, patios, and decks — creating harmonious, functional, and visually appealing environments that seamlessly connect indoor and outdoor living</p>
                </div>
            </div>
            <div className="overflow-hidden h-full md:h-[210px] w-full md:w-[300px]">
         ...
         justify-between items-start md:items-center gap-5 ">
            <div className="flex flex-col md:flex-row w-full md:w-[70%] gap-2 md:gap-8">
                ...
                <div className="service-content">
                    ...
                    <p className="GolosText text-gray-400">Overhauling existing spaces to modernize and improve functionality and aesthetics — transforming outdated interiors into stylish, efficient, and inviting environments that align with contemporary design trends and enhance everyday living experiences.</p>
                </div>
            </div>
            <div className="overflow-hidden h-full md:h-[210px] w-full md:w-[300px]">
