          ...
          <div className="flex flex-col lg:flex-row gap-5 justify-between items-center">
            <div className="w-full lg:w-1/2 relative">
              <div className="">
                ...
                <button className="mt-5 border border-gray-500/50 px-5 py-3 rounded-full GolosText font-semibold hover:bg-(--prim) hover:text-white hover:border-transparent transition-all duration-300 cursor-pointer group">
            ...
            <div className="hero-image">
                <Image
                    src={HeroImg}
                    alt="HeroImg"
                    className="w-full h-full rounded-2xl mt-12"
                  />
            </div>
            </div>
          </div>
